...
class PushTest {
    ...
    void checkPossibleMoveTest() {
        ...
        assertEquals(false, decoratedTurn.checkPossibleMove(game.getBoard().getPosition(1,4),
                game.getBoard(), game.getPlayers().get(0).getWorkers().get(0)));
        assertEquals(false, decoratedTurn.checkPossibleMove(game.getBoard().getPosition(3,2),
                game.getBoard(), game.getPlayers().get(0).getWorkers().get(0)));
        assertEquals(true, decoratedTurn.checkPossibleMove(game.getBoard().getPosition(1,2),
                game.getBoard(), game.getPlayers().get(0).getWorkers().get(0)));
    }
    ...
    void calculateMoveTest() {
        ...
        assertEquals(game.getBoard().getPosition(0,1), decoratedTurn.calculateMove(game.getPlayers().get(0).getWorkers().get(0).getPosition(),
                game.getBoard().getPosition(1,2), game.getBoard()));
        assertEquals(null, decoratedTurn.calculateMove(game.getPlayers().get(0).getWorkers().get(0).getPosition(),
                game.getBoard().getPosition(1,4), game.getBoard()));
    }
}