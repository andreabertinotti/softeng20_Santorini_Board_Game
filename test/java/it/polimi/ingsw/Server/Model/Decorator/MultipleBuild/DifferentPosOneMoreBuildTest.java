...
public class DifferentPosOneMoreBuildTest {
    ...
    void checkPossibleBuildingTest(){
        ...
        Turn decoratedTurn = new DifferentPosOneMoreBuild(turn);
        ...
        //tentativo di esguire la seconda build non sopra la prima
        ...
        //tentativo di eseguire una terza build (non sopra la seconda e neanche sopra la prima)
