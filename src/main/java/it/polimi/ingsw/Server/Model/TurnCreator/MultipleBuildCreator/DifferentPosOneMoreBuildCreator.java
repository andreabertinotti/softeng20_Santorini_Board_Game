...
import it.polimi.ingsw.Server.Model.Decorator.MultipleBuild.DifferentPosOneMoreBuild;
...
public class DifferentPosOneMoreBuildCreator implements Effect {

    /**
     * This class creates the constructor for the turn related to Demeter's ability
